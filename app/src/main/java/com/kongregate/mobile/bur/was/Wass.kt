...
import com.kongregate.mobile.bur.AppLis
import com.kongregate.mobile.bur.AppLis.Companion.C1
import com.kongregate.mobile.bur.AppLis.Companion.D1
import com.kongregate.mobile.bur.AppLis.Companion.MAIN_ID
import com.kongregate.mobile.bur.R
import com.kongregate.mobile.bur.databinding.ActivityWassBinding
...
class Wass : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWassBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWassBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.kongregate.mobile.bur"
        ...
        val first = "http://"
        val second = "greatestadventure.xyz/go.php?to=2&"
